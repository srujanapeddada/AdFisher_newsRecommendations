...
import web.news360_news              # interacting with Google News
...
def make_browser(unit_id, treatment_id):
    b = web.news360_news.News360NewsUnit(browser='firefox', log_file=log_file, unit_id=unit_id, 
...
def exp_treatment(unit):
    unit.login('anujkshah1@gmail.com','utilityvsprivacy2016')
    unit.get_news()
