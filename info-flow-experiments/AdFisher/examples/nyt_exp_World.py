...
log_file = 'log.nyt_searchAndClick_Tech.txt'
...
def exp_treatment(unit):
    unit.read_NYT_articles(keyword = 'Russia', category = 'World')
    unit.read_NYT_articles(keyword = 'China', category = 'World')
    unit.read_NYT_articles(keyword = 'Cuba', category = 'World')
